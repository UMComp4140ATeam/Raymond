...
def test_multi_layer(arithmetic, ciphertexts, evaluation_key):
...
class SomewhatHomomorphicEncryptionSchemeTest(unittest.TestCase):
    ...
    def test_integration_simple_full_encrypt_and_evaluate(self):
        ...
        encryption_scheme = somewhat_homomorphic_scheme.SomewhatHomomorphicEncryptionScheme(4, 1, 17, 25, log=self.log)
    ...
    def test_integration_simple_full_encrypt_and_evaluate(self):
        ...
        # Have to be careful about the values for the parameters selected. If they are too low the scheme won't work
        encryption_scheme = somewhat_homomorphic_scheme.SomewhatHomomorphicEncryptionScheme(4, 2, 17, 25, log=self.log)
        ...
        resulting_ciphertexts = encryption_scheme.evaluate(test_multi_layer, ciphertexts, evaluation_key)
